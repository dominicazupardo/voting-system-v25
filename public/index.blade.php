                    ...
                    <div style="display: flex; gap: 10px; align-items: center;">
                        ...
                        <div class="form-group" style="flex: 1;">
                            <select id="year" name="year" required autofocus  
                                ...
                                <option value="{{ __('1st Year') }}">{{ __('1st Year') }}</option>
                                <option value="{{ __('2nd Year') }}">{{ __('2nd Year') }}</option>
                                <option value="{{ __('3rd Year') }}">{{ __('3rd Year') }}</option>
                                <option value="{{ __('4th Year') }}">{{ __('4th Year') }}</option>
                            </select>
                            @error('year')
                                <span style="color: red; font-size: 12px;">{{ $message }}</span>
                            @enderror
                        ...
                        <!-- Block -->
                        <div class="form-group" style="flex: 1;">
                            <select id="block" name="block" required autofocus  
                                    style="width: 100%; padding: 5px; font-size: 14px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; outline: none; background-color: #fff;">
                                <option value="" disabled selected>Select Block</option>
                                <option value="{{ __('Block A') }}">{{ __('Block A') }}</option>
                                <option value="{{ __('Block B') }}">{{ __('Block B') }}</option>
                                <option value="{{ __('Block C') }}">{{ __('Block C') }}</option>
                                <option value="{{ __('Block D') }}">{{ __('Block D') }}</option>
                                <option value="{{ __('Block E') }}">{{ __('Block E') }}</option>
                                <option value="{{ __('Block F') }}">{{ __('Block F') }}</option>
                                <option value="{{ __('Block G') }}">{{ __('Block G') }}</option>
                                <option value="{{ __('Block H') }}">{{ __('Block H') }}</option>
                                <option value="{{ __('Block I') }}">{{ __('Block I') }}</option>
                                <option value="{{ __('Block J') }}">{{ __('Block J') }}</option>
                            </select>
                            @error('block')
                                <span style="color: red; font-size: 12px;">{{ $message }}</span>
                            @enderror
