    ...
    <div class="flex h-screen">
                ...
                <table class="w-full border-collapse">
                    ...
                    <tbody id="results-body">
                        ...
                        <tr class="border-b bg-white text-blue-900">
                            ...
                            <td class="px-6 py-4">{{ ucfirst($business_manager->type) }}</td>
                            <td class="px-6 py-4 text-left">
                                <form action="{{ route('business_managers.destroy', $business_manager->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                    @csrf
                                    @method('DELETE')
        ...
        <div class="flex-grow bg-gradient-to-br bg-white text-blue-900 p-10">
            ...
            <form action="{{ route('business_managers.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                ...
                <div>
                    <label for="type" class="block font-semibold">Business Manager Type</label>
