<x-app-layout>
    <div class="flex h-screen">
        ...
        <div class="flex-grow bg-gradient-to-br bg-white text-blue-900 p-10">
            <h1 class="text-3xl font-bold text-blue-900 mb-6">List of Candidates for Treasurer</h1>
                ...
                <table class="w-full border-collapse">
                    ...
                    <tbody id="results-body">
                        ...
                        <tr class="border-b bg-white text-blue-900">
                            ...
                            <td class="px-6 py-4">{{ $treasurer->candidate_no }}</td>
                        </tr>
                        @empty
                        <tr class="border-b bg-white text-blue-900">
        ...
        <div class="flex-grow bg-gradient-to-br bg-white text-blue-900 p-10">
            ...
            <form action="{{ route('treasurers.store') }}" method="POST" class="space-y-6">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <input type="number" name="candidate_no" placeholder="Candidate no." value="{{ $treasurers->count() + 1 }}" readonly>
                </div>
